...
#define DBS_INPUT_EVENT_MIN_FREQ		(700000)
...
#define DEF_STEP_UP_EARLY_HISPEED		(700000)
#define DEF_STEP_UP_INTERIM_HISPEED		(1008000)
...
#define SUP_SLOW_UP_FREQUENCY 		(700000)
#define SUP_HIGH_SLOW_UP_FREQUENCY 	(1008000)
